 ...
 */
extern int  ECP_BLS381_PUBLIC_KEY_VALIDATE(const octet *W);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS381_SVDP_DH(const octet *s,const octet *W,octet *K);
 ...
 */
extern void ECP_BLS381_ECIES_ENCRYPT(int h,const octet *P1,const octet *P2,csprng *R,const octet *W,const octet *M,int len,octet *V,octet *C,octet *T);
 ...
 */
extern int ECP_BLS381_ECIES_DECRYPT(int h,const octet *P1,const octet *P2,const octet *V,octet *C,const octet *T,const octet *U,octet *M);
 ...
 */
extern int ECP_BLS381_SP_DSA(int h,csprng *R,const octet *k,const octet *s,const octet *M,octet *c,octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS381_VP_DSA(int h,const octet *W,const octet *M,octet *c,octet *d);
/*#endif*/
