 ...
 */
extern int FP12_BLS381_iszilch(const FP12_BLS381 *x);
/**	@brief Tests for FP12 equal to unity
 *
	@param x FP12 number to be tested
	@return 1 if unity, else returns 0
 */
extern int FP12_BLS381_isunity(const FP12_BLS381 *x);
/**	@brief Copy FP12 to another FP12
 *
	@param x FP12 instance, on exit = y
	@param y FP12 instance to be copied
 */
extern void FP12_BLS381_copy(FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 */
extern int FP12_BLS381_equals(const FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 */
extern void FP12_BLS381_conj(FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 */
extern void FP12_BLS381_from_FP4(FP12_BLS381 *x,const FP4_BLS381 *a);
 ...
 */
extern void FP12_BLS381_from_FP4s(FP12_BLS381 *x,const FP4_BLS381 *a,const FP4_BLS381* b,const FP4_BLS381 *c);
 ...
 */
extern void FP12_BLS381_smul(FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 *
	...
	@param y FP12 instance, of special form
 */
extern void FP12_BLS381_ssmul(FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 */
extern void FP12_BLS381_mul(FP12_BLS381 *x,const FP12_BLS381 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_BLS381_pow(FP12_BLS381 *r,const FP12_BLS381 *x,const BIG_384_58 b);
 ...
 */
extern void FP12_BLS381_compow(FP4_BLS381 *c,const FP12_BLS381 *x,const BIG_384_58 e,const BIG_384_58 r);
 ...
 */
extern void FP12_BLS381_pow4(FP12_BLS381 *r,const FP12_BLS381 *x,const BIG_384_58 b[4]);
/**	@brief Raises an FP12 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP12 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP12_BLS381_frob(FP12_BLS381 *x,const FP2_BLS381 *f);
 ...
 */
extern void FP12_BLS381_toOctet(octet *S,const FP12_BLS381 *x);
 ...
 */
extern void FP12_BLS381_fromOctet(FP12_BLS381 *x,const octet *S);
 ...
 */
extern void FP12_BLS381_trace(FP4_BLS381 *t,const FP12_BLS381 *x);
 ...
 */
extern void FP12_BLS381_cmove(FP12_BLS381 *x,const FP12_BLS381 *y,int s);
