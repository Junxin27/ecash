 ...
 */
extern void BIG_384_58_cmove(BIG_384_58 x,const BIG_384_58 y,int s);
 ...
 *
	...
	@param s copy takes place if not equal to 0
 */
extern void BIG_384_58_dcmove(DBIG_384_58 x,const DBIG_384_58 y,int s);
/**	@brief Convert from BIG number to byte array
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_384_58_toBytes(char *a,const BIG_384_58 x);
/**	@brief Convert to BIG number from byte array
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_384_58_fromBytes(BIG_384_58 x,const char *a);
 ...
 */
extern void BIG_384_58_fromBytesLen(BIG_384_58 x,const char *a,int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_384_58_dfromBytesLen(DBIG_384_58 x,const char *a,int s);
 ...
 *
	@param x a DBIG number
 */
extern void BIG_384_58_drawoutput(const DBIG_384_58 x);
 ...
 */
extern void BIG_384_58_copy(BIG_384_58 x,const BIG_384_58 y);
/**	@brief Copy DBIG to another DBIG
 *
	@param x DBIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_58_dcopy(DBIG_384_58 x,const DBIG_384_58 y);
/**	@brief Copy BIG to upper half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_384_58_dsucopy(DBIG_384_58 x,const BIG_384_58 y);
/**	@brief Copy BIG to lower half of DBIG
 *
	@param x DBIG number
	@param y BIG number to be copied
 */
extern void BIG_384_58_dscopy(DBIG_384_58 x,const BIG_384_58 y);
/**	@brief Copy lower half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_58_sdcopy(BIG_384_58 x,const DBIG_384_58 y);
/**	@brief Copy upper half of DBIG to a BIG
 *
	@param x BIG number
	@param y DBIG number to be copied
 */
extern void BIG_384_58_sducopy(BIG_384_58 x,const DBIG_384_58 y);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_58_add(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_58_sub(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_384_58_dadd(DBIG_384_58 x,const DBIG_384_58 y,const DBIG_384_58 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_384_58_dsub(DBIG_384_58 x,const DBIG_384_58 y,const DBIG_384_58 z);
 ...
 */
extern void BIG_384_58_imul(BIG_384_58 x,const BIG_384_58 y,int i);
 ...
 */
extern chunk BIG_384_58_pmul(BIG_384_58 x,const BIG_384_58 y,int i);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_384_58_pxmul(DBIG_384_58 x,const BIG_384_58 y,int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_58_mul(DBIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_384_58_smul(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z);
 ...
 */
extern void BIG_384_58_sqr(DBIG_384_58 x,const BIG_384_58 y);
 ...
 */
extern void BIG_384_58_monty(BIG_384_58 a,const BIG_384_58 md,chunk MC,const DBIG_384_58 d);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_384_58_ssn(BIG_384_58 r,const BIG_384_58 a, BIG_384_58 m);
 ...
 */
extern chunk BIG_384_58_split(BIG_384_58 x,BIG_384_58 y,const DBIG_384_58 z,int s);
 ...
 */
extern int BIG_384_58_comp(const BIG_384_58 x,const BIG_384_58 y);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_384_58_mod(BIG_384_58 x,const BIG_384_58 n);
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_384_58_sdiv(BIG_384_58 x,const BIG_384_58 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_384_58_dmod(BIG_384_58 x,DBIG_384_58 y,const BIG_384_58 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_384_58_ddiv(BIG_384_58 x,DBIG_384_58 y,const BIG_384_58 n);
/**	@brief  return parity of BIG, that is the least significant bit
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_384_58_parity(const BIG_384_58 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_384_58_bit(const BIG_384_58 x,int i);
/**	@brief  return i-th of BIG
 *
	@param x BIG number
 ...
 */
int BIG_384_58_bits(const BIG_384_58 x, int i, int w);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_384_58_randomnum(BIG_384_58 x,const BIG_384_58 n,csprng *r);
 ...
 */
extern void BIG_384_58_modmul(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z,const BIG_384_58 n);
/**	@brief  Calculate x=y/z mod n - leaks log2(x)-log2(n)
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_58_moddiv(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 z,const BIG_384_58 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_58_modsqr(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_58_modneg(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 n);
 ...
 */
extern int BIG_384_58_jacobi(BIG_384_58 x,const BIG_384_58 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_384_58_invmodp(BIG_384_58 x,const BIG_384_58 y,const BIG_384_58 n);
