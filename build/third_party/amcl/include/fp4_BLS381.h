 ...
 */
extern int FP4_BLS381_iszilch(const FP4_BLS381 *x);
/**	@brief Tests for FP4 equal to unity
 *
	@param x FP4 number to be tested
	@return 1 if unity, else returns 0
 */
extern int FP4_BLS381_isunity(const FP4_BLS381 *x);
 ...
 */
extern int FP4_BLS381_equals(const FP4_BLS381 *x,const FP4_BLS381 *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_BLS381_isreal(const FP4_BLS381 *x);
 ...
 */
extern void FP4_BLS381_from_FP2s(FP4_BLS381 *x,const FP2_BLS381 *a,const FP2_BLS381 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BLS381_from_FP2(FP4_BLS381 *x,const FP2_BLS381 *a);
 ...
 */
extern void FP4_BLS381_from_FP2H(FP4_BLS381 *x,const FP2_BLS381 *a);
 ...
 */
extern void FP4_BLS381_copy(FP4_BLS381 *x,const FP4_BLS381 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS381_conj(FP4_BLS381 *x,const FP4_BLS381 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS381_nconj(FP4_BLS381 *x,const FP4_BLS381 *y);
 ...
 */
extern void FP4_BLS381_add(FP4_BLS381 *x,const FP4_BLS381 *y,const FP4_BLS381 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS381_sub(FP4_BLS381 *x,const FP4_BLS381 *y,FP4_BLS381 *z);
 ...
 */
extern void FP4_BLS381_pmul(FP4_BLS381 *x,FP4_BLS381 *y,const FP2_BLS381 *a);
 ...
 */
extern void FP4_BLS381_qmul(FP4_BLS381 *x,const FP4_BLS381 *y,const FP_BLS381 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS381_imul(FP4_BLS381 *x,const FP4_BLS381 *y,int i);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS381_mul(FP4_BLS381 *x,FP4_BLS381 *y,const FP4_BLS381 *z);
/**	@brief Inverting an FP4
 *
	@param x FP4 instance, on exit = 1/y
	@param y FP4 instance
 */
extern void FP4_BLS381_inv(FP4_BLS381 *x,const FP4_BLS381 *y);
 ...
 *
	@param x FP4 instance to be printed
 */
extern void FP4_BLS381_rawoutput(const FP4_BLS381 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS381_pow(FP4_BLS381 *x,const FP4_BLS381 *y,const BIG_384_58 b);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS381_xtr_A(FP4_BLS381 *r,const FP4_BLS381 *w,const FP4_BLS381 *x,FP4_BLS381 *y,const FP4_BLS381 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS381_xtr_D(FP4_BLS381 *r,const FP4_BLS381 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS381_xtr_pow(FP4_BLS381 *r,const FP4_BLS381 *x,const BIG_384_58 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS381_xtr_pow2(FP4_BLS381 *r,const FP4_BLS381 *c,const FP4_BLS381 *d,const FP4_BLS381 *e,const FP4_BLS381 *f,const BIG_384_58 a,const BIG_384_58 b);
 ...
 */
extern void FP4_BLS381_cmove(FP4_BLS381 *x,const FP4_BLS381 *y,int s);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS381_div2(FP4_BLS381 *x,const FP4_BLS381 *y);
