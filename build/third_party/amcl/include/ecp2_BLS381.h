...
/* For SSWU with AB == 0 */
extern const BIG_384_58 SSWU_A2re_BLS381; /**< Parameter A' (real part) of the Weierstrass curve for 3-isogeny for BLS12-381 G2 */
extern const BIG_384_58 SSWU_A2im_BLS381; /**< Parameter A' (imaginary part) of the Weierstrass curve for 3-isogeny for BLS12-381 G2 */
extern const BIG_384_58 SSWU_B2re_BLS381; /**< Parameter B' (real part) of the Weierstrass curve for 3-isogeny for BLS12-381 G2 */
extern const BIG_384_58 SSWU_B2im_BLS381; /**< Parameter B' (imaginary part) of the Weierstrass curve for 3-isogeny for BLS12-381 G2 */
extern const BIG_384_58 SSWU_Z2re_BLS381; /**< A non-zero element (real part) of finite field for EC mapping */
extern const BIG_384_58 SSWU_Z2im_BLS381; /**< A non-zero element (imaginary part) of finite field for EC mapping */
 ...
 */
extern int ECP2_BLS381_isinf(const ECP2_BLS381 *P);
/**	@brief Copy ECP2 point to another ECP2 point
 *
	@param P ECP2 instance, on exit = Q
	@param Q ECP2 instance to be copied
 */
extern void ECP2_BLS381_copy(ECP2_BLS381 *P,const ECP2_BLS381 *Q);
 ...
 */
extern int ECP2_BLS381_get(FP2_BLS381 *x,FP2_BLS381 *y,const ECP2_BLS381 *P);
 ...
 */
extern void ECP2_BLS381_output(const ECP2_BLS381 *P);
/**	@brief Formats and outputs an ECP2 point to the console, in projective coordinates
 *
	@param P ECP2 instance to be printed
 */
extern void ECP2_BLS381_outputxyz(const ECP2_BLS381 *P);
 ...
 */
extern void ECP2_BLS381_toOctet(octet *S,const ECP2_BLS381 *P);
 ...
 */
extern int ECP2_BLS381_fromOctet(ECP2_BLS381 *P,const octet *S);
 ...
 */
extern void ECP2_BLS381_rhs(FP2_BLS381 *r,const FP2_BLS381 *x);
 ...
 */
extern int ECP2_BLS381_set(ECP2_BLS381 *P,const FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_BLS381_setx(ECP2_BLS381 *P,const FP2_BLS381 *x);
 ...
 */
extern int ECP2_BLS381_add(ECP2_BLS381 *P,const ECP2_BLS381 *Q);
/**	@brief Subtracts ECP instance Q from ECP2 instance P
 *
	@param P ECP2 instance, on exit =P-Q
	@param Q ECP2 instance to be subtracted from P
 */
extern void ECP2_BLS381_sub(ECP2_BLS381 *P,const ECP2_BLS381 *Q);
 ...
 */
extern void ECP2_BLS381_mul(ECP2_BLS381 *P,const BIG_384_58 b);
 ...
 */
extern void ECP2_BLS381_mul4(ECP2_BLS381 *P,const ECP2_BLS381 Q[4],const BIG_384_58 b[4]);
 ...
 */
extern void ECP2_BLS381_mapit(ECP2_BLS381 *P,const octet *w);
 ...
 */
extern int ECP2_BLS381_sswu(FP2_BLS381 *x, FP2_BLS381 *y, FP2_BLS381 u);
 ...
 */
extern int ECP2_BLS381_clearcofactor(ECP2_BLS381 *P);
