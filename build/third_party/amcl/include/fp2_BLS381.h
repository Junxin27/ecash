 ...
 */
extern int FP2_BLS381_iszilch(const FP2_BLS381 *x);
 ...
 */
extern void FP2_BLS381_cmove(FP2_BLS381 *x,const FP2_BLS381 *y,int s);
/**	@brief Tests for FP2 equal to one
 *
	@param x FP2 instance to be tested
	@return 1 if x=1, else returns 0
 */
extern int FP2_BLS381_isunity(const FP2_BLS381 *x);
 ...
 */
extern int FP2_BLS381_equals(const FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 */
extern void FP2_BLS381_from_FPs(FP2_BLS381 *x,const FP_BLS381 *a,const FP_BLS381 *b);
 ...
 */
extern void FP2_BLS381_from_BIGs(FP2_BLS381 *x,const BIG_384_58 a,const BIG_384_58 b);
 ...
 *
	...
	@param a FP to form real part of FP2
 */
extern void FP2_BLS381_from_FP(FP2_BLS381 *x,const FP_BLS381 *a);
 ...
 *
	...
	@param a BIG to form real part of FP2
 */
extern void FP2_BLS381_from_BIG(FP2_BLS381 *x,const BIG_384_58 a);
/**	@brief Copy FP2 to another FP2
 *
	@param x FP2 instance, on exit = y
	@param y FP2 instance to be copied
 */
extern void FP2_BLS381_copy(FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 */
extern void FP2_BLS381_neg(FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS381_conj(FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 */
extern void FP2_BLS381_add(FP2_BLS381 *x,const FP2_BLS381 *y,const FP2_BLS381 *z);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS381_sub(FP2_BLS381 *x,const FP2_BLS381 *y,const FP2_BLS381 *z);
 ...
 *
	...
	@param b FP residue
 */
extern void FP2_BLS381_pmul(FP2_BLS381 *x,const FP2_BLS381 *y,const FP_BLS381 *b);
 ...
 *
	...
	@param i an integer
 */
extern void FP2_BLS381_imul(FP2_BLS381 *x,const FP2_BLS381 *y,int i);
/**	@brief Squaring an FP2
 *
	@param x FP2 instance, on exit = y^2
	@param y FP2 instance
 */
extern void FP2_BLS381_sqr(FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS381_mul(FP2_BLS381 *x,FP2_BLS381 *y,const FP2_BLS381 *z);
 ...
 *
	@param x FP2 instance
 */
extern void FP2_BLS381_rawoutput(const FP2_BLS381 *x);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS381_div2(FP2_BLS381 *x,const FP2_BLS381 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP2_BLS381_pow(FP2_BLS381 *x,const FP2_BLS381 *y,BIG_384_58 b);
/**	@brief Square root of an FP2
 *
	@param x FP2 instance, on exit = sqrt(y)
	@param y FP2 instance
 */
extern int FP2_BLS381_sqrt(FP2_BLS381 *x,const FP2_BLS381 *y);
