...
extern const BIG_384_58 SSWU_A1_BLS381; /**< Parameter A' of the Weierstrass curve for 11-isogeny for BLS12-381 G1 */
extern const BIG_384_58 SSWU_B1_BLS381; /**< Parameter B' of the Weierstrass curve for 11-isogeny for BLS12-381 G1 */
extern const BIG_384_58 SSWU_Z1_BLS381; /**< A non-zero element of finite field for EC mapping */
extern const BIG_384_58 H_EFF_G1;    /**< Scalar parameter for clear_cofactor for BLS12-381 G1 */
 ...
 */
extern int ECP_BLS381_isinf(const ECP_BLS381 *P);
 ...
 */
extern int ECP_BLS381_equals(const ECP_BLS381 *P,const ECP_BLS381 *Q);
/**	@brief Copy ECP point to another ECP point
 *
	@param P ECP instance, on exit = Q
	@param Q ECP instance to be copied
 */
extern void ECP_BLS381_copy(ECP_BLS381 *P,const ECP_BLS381 *Q);
 ...
 */
extern int ECP_BLS381_get(BIG_384_58 x,const ECP_BLS381 *P);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP_BLS381_set(ECP_BLS381 *P,const BIG_384_58 x,const BIG_384_58 y);
 ...
 */
extern int ECP_BLS381_get(BIG_384_58 x,BIG_384_58 y,const ECP_BLS381 *P);
/**	@brief Adds ECP instance Q to ECP instance P
 *
	@param P ECP instance, on exit =P+Q
	@param Q ECP instance to be added to P
 */
extern void ECP_BLS381_add(ECP_BLS381 *P,const ECP_BLS381 *Q);
/**	@brief Subtracts ECP instance Q from ECP instance P
 *
	@param P ECP instance, on exit =P-Q
	@param Q ECP instance to be subtracted from P
 */
extern void ECP_BLS381_sub(ECP_BLS381 *P,const ECP_BLS381 *Q);
 ...
 */
extern int ECP_BLS381_setx(ECP_BLS381 *P,const BIG_384_58 x,int s);
 ...
 */
extern void ECP_BLS381_mapit(ECP_BLS381 *Q,const octet *w);
 ...
 *
	@param P ECP instance to be printed
 */
extern void ECP_BLS381_rawoutput(const ECP_BLS381 * P);
 ...
 */
extern void ECP_BLS381_toOctet(octet *S,const ECP_BLS381 *P,bool c);
 ...
 */
extern int ECP_BLS381_fromOctet(ECP_BLS381 *P,const octet *S);
 ...
 */
extern void ECP_BLS381_mul(ECP_BLS381 *P,const BIG_384_58 b);
 ...
 */
extern void ECP_BLS381_mul2(ECP_BLS381 *P,const ECP_BLS381 *Q,const BIG_384_58 e,const BIG_384_58 f);
 ...
 */
extern int ECP_BLS381_sswu(FP_BLS381 *x, FP_BLS381 *y, FP_BLS381 u);
