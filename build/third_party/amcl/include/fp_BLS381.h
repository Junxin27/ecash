 ...
 */
extern int FP_BLS381_iszilch(const FP_BLS381 *x);
 ...
 */
extern void FP_BLS381_copy(FP_BLS381 *y,const FP_BLS381 *x);
 ...
 */
extern int FP_BLS381_equals(const FP_BLS381 *x,const FP_BLS381 *y);
 ...
 */
extern void FP_BLS381_mod(BIG_384_58 r,const DBIG_384_58 d);
 ...
 */
extern void FP_BLS381_mul(FP_BLS381 *x,const FP_BLS381 *y,const FP_BLS381 *z);
 ...
 */
extern void FP_BLS381_imul(FP_BLS381 *x,const FP_BLS381 *y,int i);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS381_add(FP_BLS381 *x,const FP_BLS381 *y,const FP_BLS381 *z);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS381_sub(FP_BLS381 *x,const FP_BLS381 *y,const FP_BLS381 *z);
/**	@brief Modular division by 2 of an FP, mod Modulus
 *
	@param x FP number, on exit =y/2 mod Modulus
	@param y FP number
 */
extern void FP_BLS381_div2(FP_BLS381 *x,const FP_BLS381 *y);
 ...
 *
	...
	@param y FP number
 */
extern void FP_BLS381_neg(FP_BLS381 *x,const FP_BLS381 *y);
/**	@brief Outputs an FP number to the console
 *
	Converts from residue form before output
	@param x an FP number
 */
extern void FP_BLS381_output(const FP_BLS381 *x);
/**	@brief Outputs an FP number to the console, in raw form
 *
	@param x a BIG number
 */
extern void FP_BLS381_rawoutput(const FP_BLS381 *x);
