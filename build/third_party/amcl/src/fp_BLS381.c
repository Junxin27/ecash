...
void FP_BLS381_nres(FP_BLS381 *y,const BIG_384_58 x)
{
...
void FP_BLS381_redc(BIG_384_58 x,const FP_BLS381 *y)
{
    BIG_384_58_copy(x,y->g);
}

/* reduce a DBIG to a BIG exploiting the special form of the modulus */
void FP_BLS381_mod(BIG_384_58 r,const DBIG_384_58 d)
{
    BIG_384_58 t;
    BIG_384_58 b;
    chunk v;
    ...
    {
        BIG_384_58_imul(t,t,(int)MConst_BLS381);
        BIG_384_58_norm(t);
    ...
    {
        v=BIG_384_58_pmul(t,t,(int)MConst_BLS381);
        BIG_384_58_add(r,t,b);
        BIG_384_58_norm(r);
        tw=r[NLEN_384_58-1];
        r[NLEN_384_58-1]&=TMASK_BLS381;
...
void FP_BLS381_mod(BIG_384_58 a,const DBIG_384_58 d)
{
    int i;
...
/* test x==0 ? */
/* SU= 48 */
int FP_BLS381_iszilch(const FP_BLS381 *x)
{
    BIG_384_58 m;
    BIG_384_58 t;
...
void FP_BLS381_copy(FP_BLS381 *y,const FP_BLS381 *x)
{
...
/* Move b to a if d=1 */
void FP_BLS381_cmove(FP_BLS381 *a,const FP_BLS381 *b,int d)
{
    sign32 c=-d;
...
int FP_BLS381_equals(const FP_BLS381 *x,const FP_BLS381 *y)
{
    FP_BLS381 xg;
    FP_BLS381 yg;
    FP_BLS381_copy(&xg,x);
...
/* output FP */
/* SU= 48 */
void FP_BLS381_output(const FP_BLS381 *r)
{
    BIG_384_58 c;
    FP_BLS381_redc(c,r);
    BIG_384_58_output(c);
...
void FP_BLS381_rawoutput(const FP_BLS381 *r)
{
...
/* SU= 88 */
void FP_BLS381_mul(FP_BLS381 *r,const FP_BLS381 *a,const FP_BLS381 *b)
{
    DBIG_384_58 d;
    FP_BLS381 a_prime;
    FP_BLS381_copy(&a_prime, a);
...
#endif
        FP_BLS381_reduce(&a_prime);  /* it is sufficient to fully reduce just one of them < p */
    }

#ifdef FUSED_MODMUL
    FP_BLS381_modmul(r->g,a_prime.g,b->g);
#else
    BIG_384_58_mul(d,a_prime.g,b->g);
    FP_BLS381_mod(r->g,d);
#endif
    r->XES=2;
}
...
/* SU= 136 */
void FP_BLS381_imul(FP_BLS381 *r,const FP_BLS381 *a,int c)
{
    int s=0;
...
/* SU= 16 */
/* Set r=a+b */
void FP_BLS381_add(FP_BLS381 *r,const FP_BLS381 *a,const FP_BLS381 *b)
{
...
/* Set r=a-b mod m */
/* SU= 56 */
void FP_BLS381_sub(FP_BLS381 *r,const FP_BLS381 *a,const FP_BLS381 *b)
{
    FP_BLS381 n;
    FP_BLS381_neg(&n,b);
    FP_BLS381_add(r,a,&n);
...
static int quo(const BIG_384_58 n,const BIG_384_58 m)
{
    int sh;
    chunk num;
    chunk den;
...
/* Set r=-a mod Modulus */
/* SU= 64 */
void FP_BLS381_neg(FP_BLS381 *r,const FP_BLS381 *a)
{
    int sb;
    BIG_384_58 m;
...
/* Set r=a/2. */
/* SU= 56 */
void FP_BLS381_div2(FP_BLS381 *r,const FP_BLS381 *a)
{
    BIG_384_58 m;
    BIG_384_58_rcopy(m,Modulus_BLS381);
    FP_BLS381_copy(r,a);
...
void FP_BLS381_pow(FP_BLS381 *r,FP_BLS381 *a,BIG_384_58 b)
{
    ...
    for (i=0; i<nb; i++)
    {
        w[i]=(signed char)BIG_384_58_lastbits(t,4);
