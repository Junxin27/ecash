...
int ECP_BLS381_isinf(const ECP_BLS381 *P)
{
...
static void ECP_BLS381_cmove(ECP_BLS381 *P,const ECP_BLS381 *Q,int d)
{
...
static void ECP_BLS381_select(ECP_BLS381 *P,const ECP_BLS381 W[],sign32 b)
{
    ECP_BLS381 MP;
    sign32 m=b>>31;
    sign32 babs=(b^m)-m;
    ...
    ECP_BLS381_cmove(P,&MP,m&1);
}
#endif

/* Test P == Q */
/* SU=168 */
int ECP_BLS381_equals(const ECP_BLS381 *P,const ECP_BLS381 *Q)
{
    FP_BLS381 a;
    FP_BLS381 b;
...
/* Set P=Q */
/* SU=16 */
void ECP_BLS381_copy(ECP_BLS381 *P,const ECP_BLS381 *Q)
{
...
int ECP_BLS381_get(BIG_384_58 x,const ECP_BLS381 *P)
{
    ECP_BLS381 W;
    ECP_BLS381_copy(&W,P);
    ECP_BLS381_affine(&W);
...
/* SU=16 */
int ECP_BLS381_get(BIG_384_58 x,BIG_384_58 y,const ECP_BLS381 *P)
{
    ECP_BLS381 W;
    int s;
    ECP_BLS381_copy(&W,P);
...
/* Set P=(x,{y}) */
/* SU=96 */
int ECP_BLS381_set(ECP_BLS381 *P,const BIG_384_58 x,const BIG_384_58 y)
{
    FP_BLS381 rhs;
    FP_BLS381 y2;
...
/* SU=136 */
int ECP_BLS381_setx(ECP_BLS381 *P,const BIG_384_58 x,int s)
{
    FP_BLS381 rhs;
    BIG_384_58 t;
    BIG_384_58 m;
...
void ECP_BLS381_mapit(ECP_BLS381 *P,const octet *W)
{
    BIG_384_58 q;
    BIG_384_58 x;
...
/* SU=16 */
/* Output point P */
void ECP_BLS381_rawoutput(const ECP_BLS381 *P)
{
    BIG_384_58 x;
    BIG_384_58 z;
...
void ECP_BLS381_toOctet(octet *W,const ECP_BLS381 *P,bool compress)
{
#if CURVETYPE_BLS381==MONTGOMERY
    BIG_384_58 x;
    ECP_BLS381_get(x,P);
...
int ECP_BLS381_fromOctet(ECP_BLS381 *P,const octet *W)
{
#if CURVETYPE_BLS381==MONTGOMERY
    BIG_384_58 x;
    ...
    if ((typ==0x02 || typ==0x03) && (ECP_BLS381_setx(P,x,typ&1)))
        return 1;
    return 0;
#endif
}
...
/* Set P+=Q */
/* SU=248 */
void ECP_BLS381_add(ECP_BLS381 *P,const ECP_BLS381 *Q)
{
#if CURVETYPE_BLS381==WEIERSTRASS
...
/* Set P-=Q */
/* SU=16 */
void  ECP_BLS381_sub(ECP_BLS381 *P,const ECP_BLS381 *Q)
{
    ECP_BLS381 NQ;
...
/* Set P=r*P */
/* SU=424 */
void ECP_BLS381_mul(ECP_BLS381 *P,const BIG_384_58 e)
{
#if CURVETYPE_BLS381==MONTGOMERY
    /* Montgomery ladder */
    int b;
    ...
    for (int i=BIGBITS_384_58-2; i>=0; i--)
    {
...
void ECP_BLS381_mul2(ECP_BLS381 *P,const ECP_BLS381 *Q,const BIG_384_58 e,const BIG_384_58 f)
{
    BIG_384_58 te;
    BIG_384_58 tf;
    BIG_384_58 mt;
    ...
    w[nb]=(signed char)(4*BIG_384_58_lastbits(te,3)+BIG_384_58_lastbits(tf,3));
...
static inline int sgn0_fp(FP_BLS381 a)
{
    BIG_384_58 b;
    FP_BLS381_redc(b, &a);
    return BIG_384_58_parity(b);
}

int ECP_BLS381_sswu(FP_BLS381 *x, FP_BLS381 *y, FP_BLS381 u)
{
    if (x == NULL || y == NULL)
        return -1;
