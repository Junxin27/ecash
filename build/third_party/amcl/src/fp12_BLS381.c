...
static void FP12_BLS381_select(FP12_BLS381 *f,const FP12_BLS381 g[],sign32 b)
{
    FP12_BLS381 invf;
    sign32 m=b>>31;
    sign32 babs=(b^m)-m;
...
/* test x==0 ? */
/* SU= 8 */
int FP12_BLS381_iszilch(const FP12_BLS381 *x)
{
...
/* test x==1 ? */
/* SU= 8 */
int FP12_BLS381_isunity(const FP12_BLS381 *x)
{
...
/* FP12 copy w=x */
/* SU= 16 */
void FP12_BLS381_copy(FP12_BLS381 *w,const FP12_BLS381 *x)
{
    if (x==w) return;
...
/* SU= 16 */
int FP12_BLS381_equals(const FP12_BLS381 *x,const FP12_BLS381 *y)
{
...
/* Set w=conj(x) */
/* SU= 8 */
void FP12_BLS381_conj(FP12_BLS381 *w,const FP12_BLS381 *x)
{
...
/* SU= 8 */
void FP12_BLS381_from_FP4(FP12_BLS381 *w,const FP4_BLS381 *a)
{
...
/* SU= 16 */
void FP12_BLS381_from_FP4s(FP12_BLS381 *w,const FP4_BLS381 *a,const FP4_BLS381 *b,const FP4_BLS381 *c)
{
    FP4_BLS381_copy(&(w->a),a);
...
/* SU= 896 */
/* FP12 full multiplication w=w*y */
void FP12_BLS381_mul(FP12_BLS381 *w,const FP12_BLS381 *y)
{
    FP4_BLS381 z0;
    FP4_BLS381 z1;
    FP4_BLS381 z2;
...
void FP12_BLS381_ssmul(FP12_BLS381 *w,const FP12_BLS381 *y)
{
    FP4_BLS381 z0;
    FP4_BLS381 z1;
    FP4_BLS381 z2;
...
void FP12_BLS381_smul(FP12_BLS381 *w,const FP12_BLS381 *y)
{
    FP2_BLS381 w1;
    FP2_BLS381 w2;
    FP2_BLS381 w3;
...
void FP12_BLS381_compow(FP4_BLS381 *c,const FP12_BLS381 *x,const BIG_384_58 e,const BIG_384_58 r)
{
    FP12_BLS381 g1;
    FP12_BLS381 g2;
    FP4_BLS381 cp;
...
void FP12_BLS381_pow(FP12_BLS381 *r,const FP12_BLS381 *a,const BIG_384_58 b)
{
    FP12_BLS381 w;
    FP12_BLS381 sf;
    BIG_384_58 b1;
...
void FP12_BLS381_pow4(FP12_BLS381 *p,const FP12_BLS381 *q,const BIG_384_58 u[4])
{
    int i;
    int k;
    int nb;
...
/* SU= 160 */
void FP12_BLS381_frob(FP12_BLS381 *w,const FP2_BLS381 *f)
{
    FP2_BLS381 f2;
    FP2_BLS381 f3;
...
/* SU= 8 */
void FP12_BLS381_trace(FP4_BLS381 *w,const FP12_BLS381 *x)
{
...
void FP12_BLS381_toOctet(octet *W,const FP12_BLS381 *g)
{
    BIG_384_58 a;
...
void FP12_BLS381_fromOctet(FP12_BLS381 *g,const octet *W)
{
    BIG_384_58 b;
...
/* Move b to a if d=1 */
void FP12_BLS381_cmove(FP12_BLS381 *f,const FP12_BLS381 *g,int d)
{
