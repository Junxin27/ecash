...
/* Line function */
static void PAIR_BLS381_line(FP12_BLS381 *v,ECP2_BLS381 *A,const ECP2_BLS381 *B,const FP_BLS381 *Qx,const FP_BLS381 *Qy)
{
    FP2_BLS381 X1;
    FP2_BLS381 Y1;
    FP2_BLS381 T1;
...
{
    for (int i=ATE_BITS_BLS381-1; i>=0; i--)
        FP12_BLS381_one(&r[i]);
    return;
}

/* basic Miller loop */
void PAIR_BLS381_miller(FP12_BLS381 *res,const FP12_BLS381 r[])
{
    FP12_BLS381_one(res);
    for (int i=ATE_BITS_BLS381-1; i>=1; i--)
    {
...
void PAIR_BLS381_another(FP12_BLS381 r[],const ECP2_BLS381* PV,const ECP_BLS381* QV)
{
    int nb;
    int bt;
    BIG_384_58 n;
...
void PAIR_BLS381_ate(FP12_BLS381 *r,const ECP2_BLS381 *P1,const ECP_BLS381 *Q1)
{
    BIG_384_58 n;
    BIG_384_58 n3;
    FP_BLS381 Qx;
...
void PAIR_BLS381_double_ate(FP12_BLS381 *r,const ECP2_BLS381 *P1,const ECP_BLS381 *Q1,const ECP2_BLS381 *R1,const ECP_BLS381 *S1)
{
    BIG_384_58 n;
    BIG_384_58 n3;
    FP_BLS381 Qx;
...
static void gs(BIG_384_58 u[4],const BIG_384_58 e)
{
#if PAIRING_FRIENDLY_BLS381==BN
    int j;
    BIG_384_58 v[4];
...
void PAIR_BLS381_G1mul(ECP_BLS381 *P,const BIG_384_58 e)
{
...
void PAIR_BLS381_G2mul(ECP2_BLS381 *P,const BIG_384_58 e)
{
...
/* f=f^e */
void PAIR_BLS381_GTpow(FP12_BLS381 *f,const BIG_384_58 e)
{
